...
#define PERM_ADMIN_ACT  (PERM_SYSOP | PERM_BBSADM | PERM_ACCOUNTS | PERM_ACCTREG)
#define PERM_ADMIN_BRD  (PERM_SYSOP | PERM_BBSADM | PERM_BOARD | PERM_SYSSUPERSUBOP | PERM_SYSSUBOP)
